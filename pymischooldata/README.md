...
Python wrapper for Michigan school enrollment data.

This is a thin rpy2 wrapper around the [mischooldata](https://github.com/almartin82/mischooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `mischooldata` R package installed
...
# Fetch one year
df = mi.fetch_enr(2025)

# Fetch multiple years
df_multi = mi.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
