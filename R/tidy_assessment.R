...
# format (with pct_not_proficient, pct_partially_proficient, etc. columns)
# to long (tidy) format with a proficiency_level column.
#
# Michigan proficiency levels:
...
#' The wide format has separate columns for each proficiency level
#' (pct_not_proficient, pct_partially_proficient, pct_proficient, pct_advanced).
#' The tidy format pivots these into a single proficiency_level column.
#'
...
tidy_assessment <- function(df) {
  ...
  prof_cols <- c("pct_not_proficient", "pct_partially_proficient", "pct_proficient", "pct_advanced")
  ...
  level_names <- c(
    "pct_not_proficient" = "not_proficient",
    "pct_partially_proficient" = "partially_proficient",
...
#' Calculate proficiency rates (proficient + advanced)
#'
#' Calculates the combined proficiency rate (students scoring proficient or
...
calc_proficiency <- function(df, ...) {
  ...
  # If grouping vars provided, group by them
