...
![](enrollment-trends_files/figure-html/dearborn-enrollment-1.png)
...
![](enrollment-trends_files/figure-html/lansing-stable-1.png)
...
![](enrollment-trends_files/figure-html/hs-vs-elem-1.png)
...
![](enrollment-trends_files/figure-html/demographic-shift-1.png)
...
#> [1] scales_1.4.0       dplyr_1.1.4        ggplot2_4.0.1      mischooldata_0.1.0
#> 
...
#> [41] tools_4.5.0        pkgconfig_2.0.3    htmltools_0.5.9
```
