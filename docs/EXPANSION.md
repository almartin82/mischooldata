...
**Last Updated:** 2026-01-04 **Theme Researched:** Graduation/Dropout
Rates
...
Michigan provides cohort-based graduation and dropout rate data through
CEPI (Center for Educational Performance and Information) at MI School
Data.
...
Historical graduation/dropout data available in DBF (dBASE) format at
district and building level. These use a different calculation
methodology (not cohort-based).
...
1.  **Suppression markers**: `< 10` for small counts (privacy
    protection)
...
5.  **Different file naming patterns by year**: No consistent URL
    pattern
...
**The mischooldata package is currently FAILING R-CMD-check.** Before
implementing graduation data, the existing issues must be fixed first.
...
- [Understanding Michigan’s Cohort Graduation and Dropout
  Rates](https://www.michigan.gov/-/media/Project/Websites/cepi/MSDS/Understanding-Michigans-Cohort-GradDrop-Rates.pdf)
- [FAQs of Michigan’s Cohort Graduation and Dropout
  Rates](https://www.michigan.gov/cepi/-/media/Project/Websites/cepi/MSDS/FAQs-of-Michigans-Cohort-Graduation-and-Dropout-Rates.pdf)
