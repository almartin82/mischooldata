...
# Skip vignette evaluation on CI to avoid network dependencies
# Users can run locally to see live results
...
# Fetch data
enr <- fetch_enr_multi((max_year - 7, use_cache = TRUE):max_year)
...
## 1. Detroit's collapse is staggering {#detroits-collapse-is-staggering}
...
## 2. Statewide enrollment has been declining {#statewide-enrollment-has-been-declining}
...
## 3. Grand Rapids is more diverse than you think {#grand-rapids-is-more-diverse-than-you-think}
...
## 4. The Upper Peninsula is emptying out {#the-upper-peninsula-is-emptying-out}
...
## 5. COVID hit kindergarten hard {#covid-hit-kindergarten-hard}
...
## 6. Ann Arbor: island of stability {#ann-arbor-island-of-stability}
...
## 7. Multiracial enrollment growing fastest {#multiracial-enrollment-growing-fastest}

Multiracial students are Michigan's fastest-growing demographic, increasing 31% from 57,291 to 75,055 students since 2018. While overall enrollment declines, multiracial and Hispanic populations continue to grow, reshaping the state's educational demographics.
...
## 8. Largest districts by enrollment {#largest-districts-by-enrollment}
...
## 9. Flint's water crisis visible in enrollment {#flints-water-crisis-visible-in-enrollment}
...
## 10. Oakland County suburbs holding {#oakland-county-suburbs-holding}
...
## 11. Dearborn: Arab American educational hub {#dearborn-arab-american-hub}
...
## 12. Black student enrollment declining {#black-enrollment-declining}
...
## 13. Lansing bucking the urban decline {#lansing-bucking-decline}

Unlike Detroit and Flint, Lansing School District has maintained relatively stable enrollment. The state capital's diverse economy and state government employment provide a buffer against the losses seen in other urban cores.
...
## 14. High school enrollment shrinking faster {#high-school-shrinking}
...
## 15. Demographic transformation: Michigan's changing face {#demographic-transformation}

Michigan's racial demographics are shifting dramatically. White student enrollment has declined substantially while Hispanic and multiracial populations grow. This transformation will reshape Michigan education for decades.
